    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                ...
                'ICollege-ui': {
                    files: [
                        'bower_components/ICollege-ui/dist/css/*.css'
                    ],
                    tasks: ['copy:dev']
                },
                livereload: {
                ...
                dev: {
                    options: {
                        ...
                        templateRegistration: function (name, template) {
                            return grunt.config.process("define('ICollege/") + name + "', ['exports'], function(__exports__){ __exports__['default'] = " + template + "; });";
                        }
                    },
                    files: {
            ...
            concat_sourcemap: {
                client: {
                    ...
                    dest: 'core/built/scripts/ICollege-dev-ember.js',
                    options: {
                        sourcesContent: true
                    }
                }
            ...
            copy: {
                dev: {
                    files: [{
                        ...
                        cwd: 'bower_components/ICollege-ui/dist/',
                        src: ['**'],
            ...
            concat: {
                ...
                prod: {
                    files: {
                        'core/built/scripts/ICollege.js': [
                            'bower_components/jquery/dist/jquery.js',
                            'bower_components/jquery-ui/ui/jquery-ui.js',
                            'core/clientold/assets/lib/jquery-utils.js',
                            'core/clientold/assets/lib/uploader.js',
            ...
            uglify: {
                prod: {
                    files: {
                        'core/built/scripts/ICollege.min.js': 'core/built/scripts/ICollege.js',
        ...
        grunt.registerTask('help',
            ...
            function () {
                console.log('Type `grunt --help` to get the details of available grunt tasks, ' +
                    'or alternatively visit https://github.com/TryGhost/ICollege/wiki/Grunt-Toolkit');
            });
        ...
        // GitHub or from https://ICollege.org/download. These zip files are created using the [grunt release](#release)
        // task.
        //
        ...
        // ### Release
        // Run `grunt release` to create a ICollege release zip file.
