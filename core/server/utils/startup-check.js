var packages = require('../../../package.json'),
    ...
    configFilePath = process.env.ICOLLEGE_CONFIG || path.join(appRoot, 'config.js'),
    checks;
...
checks = {
    ...
    packages: function checkPackages() {
        ...
        console.error('\x1B[31mERROR: iCollege is unable to start due to missing dependencies:\033[0m\n  ' + errors);
        console.error('\x1B[32m\nPlease run `npm install --production` and try starting iCollege again.');
        console.error('\x1B[32mHelp and documentation can be found at https://42.96.195.83/guanggu/icollege/wikis/home.\033[0m\n');
    ...
    contentPath: function checkContentPaths() {
        ...
        var configFile,
            ...
            fd,
            errorHeader = '\x1B[31mERROR: Unable to access iCollege\'s content path:\033[0m',
            errorHelp = '\x1B[32mCheck that the content path exists and file system permissions are correct.' +
                '\nHelp and documentation can be found at https://42.96.195.83/guanggu/icollege/wikis/home.\033[0m';
    ...
    sqlite: function checkSqlite() {
        ...
        try {
            ...
            if (config && config.database && config.database.sqlite3 && config.database.sqlite3.connection) {
                dbPath = config.database.sqlite3.connection.filename;
            }
        } catch (e) {
        ...
        try {
            ...
            console.error('Help and documentation can be found at https://42.96.195.83/guanggu/icollege/wikis/home.\033[0m');
